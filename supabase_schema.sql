...
drop function if exists public.current_wallet_address();
drop function if exists public.wallet_address_from_session_header();
drop function if exists public.jwt_wallet_address();
